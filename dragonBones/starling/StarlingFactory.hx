...
public final class StarlingFactory extends BaseFactory
{
	 ...
	 * @private
	 */
	private static inline var _eventManager:StarlingArmatureDisplay = new StarlingArmatureDisplay();
	/**
	 * @private
	 */
	 ...
	 */
	public static inline var factory:StarlingFactory = new StarlingFactory();
	/**
	 * @private
	 */
	...
	override private function _generateArmature(dataPackage:BuildArmaturePackage):Armature
	{
		...
		inline var armatureDisplay:StarlingArmatureDisplay = new StarlingArmatureDisplay();
